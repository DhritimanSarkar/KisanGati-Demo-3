...
def _json_safe(value):
    """Convert PostgreSQL Decimal values to JSON-safe Python numbers."""
...
from database import db, allocate_token_number, get_current_queue_token, advance_queue_token

app = Flask(__name__)
_secret_key = os.getenv("SECRET_KEY")
if os.getenv("VERCEL") and not _secret_key:
    raise RuntimeError("SECRET_KEY must be configured in Vercel Environment Variables.")
app.secret_key = _secret_key or "sih26032-demo-secret"
app.config.update(
...
# ---------------- REGISTRATION SUCCESS CARD TRANSLATIONS ----------------
_REGISTRATION_SUCCESS_TRANSLATIONS = {
    "en": {"registration_complete":"Registration Complete ✓","registration_success_sub":"Your farmer registration has been saved successfully.","digital_token_label":"Digital Token","tracking_id_label":"Tracking ID","registered_farmer":"Farmer","registered_crop":"Crop","registered_quantity":"Quantity","quantity_unit":"quintals","booked_slot":"Booked Slot","token_note":"Keep your digital token safe. Use it with your registered mobile number to log in and track your procurement.","view_dashboard":"View Dashboard","track_shipment":"Track Shipment"},
    "hi": {"registration_complete":"पंजीकरण सफल ✓","registration_success_sub":"आपका किसान पंजीकरण सफलतापूर्वक सहेजा गया है।","digital_token_label":"डिजिटल टोकन","tracking_id_label":"ट्रैकिंग ID","registered_farmer":"किसान","registered_crop":"फसल","registered_quantity":"मात्रा","quantity_unit":"क्विंटल","booked_slot":"बुक किया गया स्लॉट","token_note":"अपना डिजिटल टोकन सुरक्षित रखें। लॉगिन और खरीद की ट्रैकिंग के लिए इसे अपने पंजीकृत मोबाइल नंबर के साथ उपयोग करें।","view_dashboard":"डैशबोर्ड देखें","track_shipment":"शिपमेंट ट्रैक करें"},
    "bn": {"registration_complete":"নিবন্ধন সম্পন্ন ✓","registration_success_sub":"আপনার কৃষক নিবন্ধন সফলভাবে সংরক্ষণ করা হয়েছে।","digital_token_label":"ডিজিটাল টোকেন","tracking_id_label":"ট্র্যাকিং ID","registered_farmer":"কৃষক","registered_crop":"ফসল","registered_quantity":"পরিমাণ","quantity_unit":"কুইন্টাল","booked_slot":"বুক করা স্লট","token_note":"আপনার ডিজিটাল টোকেন নিরাপদে রাখুন। লগইন ও ক্রয় ট্র্যাক করতে এটি নিবন্ধিত মোবাইল নম্বরের সাথে ব্যবহার করুন।","view_dashboard":"ড্যাশবোর্ড দেখুন","track_shipment":"শিপমেন্ট ট্র্যাক করুন"},
    "ta": {"registration_complete":"பதிவு முடிந்தது ✓","registration_success_sub":"உங்கள் விவசாயி பதிவு வெற்றிகரமாக சேமிக்கப்பட்டது.","digital_token_label":"டிஜிட்டல் டோக்கன்","tracking_id_label":"கண்காணிப்பு ID","registered_farmer":"விவசாயி","registered_crop":"பயிர்","registered_quantity":"அளவு","quantity_unit":"குவிண்டால்","booked_slot":"முன்பதிவு செய்த ஸ்லாட்","token_note":"உங்கள் டிஜிட்டல் டோக்கனை பாதுகாப்பாக வைத்திருங்கள். உள்நுழைவு மற்றும் கொள்முதல் கண்காணிப்புக்கு பதிவு செய்த மொபைல் எண்ணுடன் பயன்படுத்தவும்.","view_dashboard":"டாஷ்போர்டைப் பார்க்கவும்","track_shipment":"ஷிப்மென்ட்டை கண்காணிக்கவும்"},
    "as": {"registration_complete":"পঞ্জীয়ন সম্পূৰ্ণ ✓","registration_success_sub":"আপোনাৰ কৃষক পঞ্জীয়ন সফলভাৱে সংৰক্ষণ কৰা হৈছে।","digital_token_label":"ডিজিটেল টোকেন","tracking_id_label":"ট্ৰেকিং ID","registered_farmer":"কৃষক","registered_crop":"শস্য","registered_quantity":"পৰিমাণ","quantity_unit":"কুইণ্টল","booked_slot":"বুক কৰা স্লট","token_note":"আপোনাৰ ডিজিটেল টোকেন সুৰক্ষিত ৰাখক। লগইন আৰু ক্ৰয় অনুসৰণ কৰিবলৈ পঞ্জীয়ন কৰা মোবাইল নম্বৰৰ সৈতে ইয়াক ব্যৱহাৰ কৰক।","view_dashboard":"ডেশ্বব’ৰ্ড চাওক","track_shipment":"শিপমেণ্ট অনুসৰণ কৰক"},
    "te": {"registration_complete":"నమోదు పూర్తైంది ✓","registration_success_sub":"మీ రైతు నమోదు విజయవంతంగా సేవ్ చేయబడింది.","digital_token_label":"డిజిటల్ టోకెన్","tracking_id_label":"ట్రాకింగ్ ID","registered_farmer":"రైతు","registered_crop":"పంట","registered_quantity":"పరిమాణం","quantity_unit":"క్వింటాళ్లు","booked_slot":"బుక్ చేసిన స్లాట్","token_note":"మీ డిజిటల్ టోకెన్‌ను భద్రంగా ఉంచండి. లాగిన్ మరియు కొనుగోలు ట్రాకింగ్ కోసం నమోదు చేసిన మొబైల్ నంబర్‌తో ఉపయోగించండి.","view_dashboard":"డాష్‌బోర్డ్ చూడండి","track_shipment":"షిప్‌మెంట్‌ను ట్రాక్ చేయండి"},
    "mr": {"registration_complete":"नोंदणी पूर्ण ✓","registration_success_sub":"तुमची शेतकरी नोंदणी यशस्वीपणे जतन झाली आहे.","digital_token_label":"डिजिटल टोकन","tracking_id_label":"ट्रॅकिंग ID","registered_farmer":"शेतकरी","registered_crop":"पीक","registered_quantity":"प्रमाण","quantity_unit":"क्विंटल","booked_slot":"बुक केलेला स्लॉट","token_note":"तुमचे डिजिटल टोकन सुरक्षित ठेवा. लॉगिन आणि खरेदी ट्रॅकिंगसाठी नोंदणीकृत मोबाईल नंबरसोबत वापरा.","view_dashboard":"डॅशबोर्ड पहा","track_shipment":"शिपमेंट ट्रॅक करा"},
    "gu": {"registration_complete":"નોંધણી પૂર્ણ ✓","registration_success_sub":"તમારી ખેડૂત નોંધણી સફળતાપૂર્વક સાચવાઈ ગઈ છે.","digital_token_label":"ડિજિટલ ટોકન","tracking_id_label":"ટ્રેકિંગ ID","registered_farmer":"ખેડૂત","registered_crop":"પાક","registered_quantity":"જથ્થો","quantity_unit":"ક્વિન્ટલ","booked_slot":"બુક કરેલ સ્લોટ","token_note":"તમારું ડિજિટલ ટોકન સુરક્ષિત રાખો. લૉગિન અને ખરીદી ટ્રેકિંગ માટે નોંધાયેલ મોબાઇલ નંબર સાથે તેનો ઉપયોગ કરો.","view_dashboard":"ડેશબોર્ડ જુઓ","track_shipment":"શિપમેન્ટ ટ્રેક કરો"},
    "kn": {"registration_complete":"ನೋಂದಣಿ ಪೂರ್ಣಗೊಂಡಿದೆ ✓","registration_success_sub":"ನಿಮ್ಮ ರೈತ ನೋಂದಣಿಯನ್ನು ಯಶಸ್ವಿಯಾಗಿ ಉಳಿಸಲಾಗಿದೆ.","digital_token_label":"ಡಿಜಿಟಲ್ ಟೋಕನ್","tracking_id_label":"ಟ್ರ್ಯಾಕಿಂಗ್ ID","registered_farmer":"ರೈತ","registered_crop":"ಬೆಳೆ","registered_quantity":"ಪ್ರಮಾಣ","quantity_unit":"ಕ್ವಿಂಟಾಲ್","booked_slot":"ಬುಕ್ ಮಾಡಿದ ಸ್ಲಾಟ್","token_note":"ನಿಮ್ಮ ಡಿಜಿಟಲ್ ಟೋಕನ್ ಅನ್ನು ಸುರಕ್ಷಿತವಾಗಿ ಇಟ್ಟುಕೊಳ್ಳಿ. ಲಾಗಿನ್ ಮತ್ತು ಖರೀದಿ ಟ್ರ್ಯಾಕಿಂಗ್‌ಗಾಗಿ ನೋಂದಾಯಿತ ಮೊಬೈಲ್ ಸಂಖ್ಯೆಯೊಂದಿಗೆ ಬಳಸಿ.","view_dashboard":"ಡ್ಯಾಶ್‌ಬೋರ್ಡ್ ನೋಡಿ","track_shipment":"ಶಿಪ್‌ಮೆಂಟ್ ಟ್ರ್ಯಾಕ್ ಮಾಡಿ"},
    "ml": {"registration_complete":"രജിസ്ട്രേഷൻ പൂർത്തിയായി ✓","registration_success_sub":"നിങ്ങളുടെ കർഷക രജിസ്ട്രേഷൻ വിജയകരമായി സേവ് ചെയ്തു.","digital_token_label":"ഡിജിറ്റൽ ടോക്കൺ","tracking_id_label":"ട്രാക്കിംഗ് ID","registered_farmer":"കർഷകൻ","registered_crop":"വിള","registered_quantity":"അളവ്","quantity_unit":"ക്വിന്റൽ","booked_slot":"ബുക്ക് ചെയ്ത സ്ലോട്ട്","token_note":"നിങ്ങളുടെ ഡിജിറ്റൽ ടോക്കൺ സുരക്ഷിതമായി സൂക്ഷിക്കുക. ലോഗിൻ ചെയ്യാനും വാങ്ങൽ ട്രാക്ക് ചെയ്യാനും രജിസ്റ്റർ ചെയ്ത മൊബൈൽ നമ്പറിനൊപ്പം ഉപയോഗിക്കുക.","view_dashboard":"ഡാഷ്ബോർഡ് കാണുക","track_shipment":"ഷിപ്മെന്റ് ട്രാക്ക് ചെയ്യുക"},
    "or": {"registration_complete":"ପଞ୍ଜୀକରଣ ସମ୍ପୂର୍ଣ୍ଣ ✓","registration_success_sub":"ଆପଣଙ୍କ ଚାଷୀ ପଞ୍ଜୀକରଣ ସଫଳତାର ସହ ସଂରକ୍ଷିତ ହୋଇଛି।","digital_token_label":"ଡିଜିଟାଲ୍ ଟୋକେନ୍","tracking_id_label":"ଟ୍ରାକିଂ ID","registered_farmer":"ଚାଷୀ","registered_crop":"ଫସଲ","registered_quantity":"ପରିମାଣ","quantity_unit":"କୁଇଣ୍ଟାଲ୍","booked_slot":"ବୁକ୍ କରାଯାଇଥିବା ସ୍ଲଟ୍","token_note":"ଆପଣଙ୍କ ଡିଜିଟାଲ୍ ଟୋକେନ୍ ସୁରକ୍ଷିତ ରଖନ୍ତୁ। ଲଗଇନ୍ ଏବଂ କ୍ରୟ ଟ୍ରାକିଂ ପାଇଁ ପଞ୍ଜୀକୃତ ମୋବାଇଲ୍ ନମ୍ବର ସହିତ ବ୍ୟବହାର କରନ୍ତୁ।","view_dashboard":"ଡ୍ୟାସବୋର୍ଡ ଦେଖନ୍ତୁ","track_shipment":"ଶିପମେଣ୍ଟ ଟ୍ରାକ୍ କରନ୍ତୁ"},
    "pa": {"registration_complete":"ਰਜਿਸਟ੍ਰੇਸ਼ਨ ਪੂਰੀ ✓","registration_success_sub":"ਤੁਹਾਡੀ ਕਿਸਾਨ ਰਜਿਸਟ੍ਰੇਸ਼ਨ ਸਫਲਤਾਪੂਰਵਕ ਸੇਵ ਹੋ ਗਈ ਹੈ।","digital_token_label":"ਡਿਜ਼ਿਟਲ ਟੋਕਨ","tracking_id_label":"ਟ੍ਰੈਕਿੰਗ ID","registered_farmer":"ਕਿਸਾਨ","registered_crop":"ਫਸਲ","registered_quantity":"ਮਾਤਰਾ","quantity_unit":"ਕੁਇੰਟਲ","booked_slot":"ਬੁੱਕ ਕੀਤਾ ਸਲਾਟ","token_note":"ਆਪਣਾ ਡਿਜ਼ਿਟਲ ਟੋਕਨ ਸੁਰੱਖਿਅਤ ਰੱਖੋ। ਲੌਗਇਨ ਅਤੇ ਖਰੀਦ ਟ੍ਰੈਕਿੰਗ ਲਈ ਇਸਨੂੰ ਰਜਿਸਟਰਡ ਮੋਬਾਈਲ ਨੰਬਰ ਨਾਲ ਵਰਤੋ।","view_dashboard":"ਡੈਸ਼ਬੋਰਡ ਵੇਖੋ","track_shipment":"ਸ਼ਿਪਮੈਂਟ ਟ੍ਰੈਕ ਕਰੋ"}
}
for _code, _vals in _REGISTRATION_SUCCESS_TRANSLATIONS.items():
    TRANSLATIONS[_code].update(_vals)
...
# ---------------- FARMER REGISTRATION SIDE-CARD TRANSLATIONS ----------------
_FARMER_PORTAL_CARDS = {
    "en": {
        "centre_card_title":"📍 Nearest Procurement Centre","centre_name":"Kisan Procurement Centre",
        "centre_distance":"Distance: 4.2 km","centre_open":"Open today","centre_hours":"10:00 AM – 5:00 PM",
        "view_location":"View Location","proc_info_title":"💰 Procurement Information","proc_crop":"Crop",
        "proc_rate":"Today's indicative rate:","per_quintal":" / quintal","proc_payment":"Payment:",
        "bank_transfer":"✓ Direct bank transfer","digital_status":"✓ Digital payment status","track_payment":"✓ Track payment after procurement",
        "ai_quick_title":"🤖 AI Assistant Quick Questions","ai_quick_sub":"Need help? Ask KisanGati",
        "ai_q1":"How do I book a slot?","ai_q2":"When should I reach?","ai_q3":"Where is my produce?","ai_q4":"How can I check payment?",
        "indicative_note":"Indicative rate is updated by the procurement centre."
    },
    "hi": {
        "centre_card_title":"📍 निकटतम खरीद केंद्र","centre_name":"किसान खरीद केंद्र",
        "centre_distance":"दूरी: 4.2 किमी","centre_open":"आज खुला है","centre_hours":"सुबह 10:00 – शाम 5:00 बजे",
        "view_location":"स्थान देखें","proc_info_title":"💰 खरीद जानकारी","proc_crop":"फसल",
        "proc_rate":"आज की संकेतात्मक दर:","per_quintal":" / क्विंटल","proc_payment":"भुगतान:",
        "bank_transfer":"✓ सीधे बैंक खाते में भुगतान","digital_status":"✓ डिजिटल भुगतान स्थिति","track_payment":"✓ खरीद के बाद भुगतान ट्रैक करें",
        "ai_quick_title":"🤖 AI सहायक के त्वरित प्रश्न","ai_quick_sub":"मदद चाहिए? KisanGati से पूछें",
        "ai_q1":"मैं स्लॉट कैसे बुक करूं?","ai_q2":"मुझे कब पहुंचना चाहिए?","ai_q3":"मेरी उपज कहां है?","ai_q4":"मैं भुगतान कैसे जांचूं?",
        "indicative_note":"संकेतात्मक दर खरीद केंद्र द्वारा अपडेट की जाती है।"
    },
    "bn": {
        "centre_card_title":"📍 নিকটতম ক্রয় কেন্দ্র","centre_name":"কিষান ক্রয় কেন্দ্র",
        "centre_distance":"দূরত্ব: 4.2 কিমি","centre_open":"আজ খোলা","centre_hours":"সকাল 10:00 – বিকেল 5:00",
        "view_location":"অবস্থান দেখুন","proc_info_title":"💰 ক্রয় তথ্য","proc_crop":"ফসল",
        "proc_rate":"আজকের নির্দেশক মূল্য:","per_quintal":" / কুইন্টাল","proc_payment":"পেমেন্ট:",
        "bank_transfer":"✓ সরাসরি ব্যাংক ট্রান্সফার","digital_status":"✓ ডিজিটাল পেমেন্টের অবস্থা","track_payment":"✓ ক্রয়ের পরে পেমেন্ট ট্র্যাক করুন",
        "ai_quick_title":"🤖 AI সহায়কের দ্রুত প্রশ্ন","ai_quick_sub":"সাহায্য দরকার? KisanGati-কে জিজ্ঞাসা করুন",
        "ai_q1":"আমি কীভাবে স্লট বুক করব?","ai_q2":"আমার কখন পৌঁছানো উচিত?","ai_q3":"আমার ফসল কোথায়?","ai_q4":"আমি কীভাবে পেমেন্ট দেখব?",
        "indicative_note":"নির্দেশক মূল্য ক্রয় কেন্দ্র আপডেট করে।"
    },
    "ta": {
        "centre_card_title":"📍 அருகிலுள்ள கொள்முதல் மையம்","centre_name":"கிசான் கொள்முதல் மையம்",
        "centre_distance":"தூரம்: 4.2 கி.மீ","centre_open":"இன்று திறந்திருக்கும்","centre_hours":"காலை 10:00 – மாலை 5:00",
        "view_location":"இடத்தைப் பார்க்கவும்","proc_info_title":"💰 கொள்முதல் தகவல்","proc_crop":"பயிர்",
        "proc_rate":"இன்றைய குறியீட்டு விலை:","per_quintal":" / குவிண்டால்","proc_payment":"பணம்:",
        "bank_transfer":"✓ நேரடி வங்கி பரிமாற்றம்","digital_status":"✓ டிஜிட்டல் பணப்பரிவர்த்தனை நிலை","track_payment":"✓ கொள்முதலுக்குப் பிறகு பணத்தை கண்காணிக்கவும்",
        "ai_quick_title":"🤖 AI உதவியாளர் விரைவு கேள்விகள்","ai_quick_sub":"உதவி வேண்டுமா? KisanGati-யிடம் கேளுங்கள்",
        "ai_q1":"ஸ்லாட்டை எப்படி முன்பதிவு செய்வது?","ai_q2":"நான் எப்போது வர வேண்டும்?","ai_q3":"என் விளைபொருள் எங்கே உள்ளது?","ai_q4":"பணப்பரிவர்த்தனையை எப்படி சரிபார்ப்பது?",
        "indicative_note":"குறியீட்டு விலை கொள்முதல் மையத்தால் புதுப்பிக்கப்படுகிறது."
    },
    "as": {
        "centre_card_title":"📍 নিকটতম ক্ৰয় কেন্দ্ৰ","centre_name":"কিষাণ ক্ৰয় কেন্দ্ৰ",
        "centre_distance":"দূৰত্ব: 4.2 কিমি","centre_open":"আজি খোলা","centre_hours":"পুৱা 10:00 – আবেলি 5:00",
        "view_location":"অৱস্থান চাওক","proc_info_title":"💰 ক্ৰয়ৰ তথ্য","proc_crop":"শস্য",
        "proc_rate":"আজিৰ সূচকীয় হাৰ:","per_quintal":" / কুইণ্টল","proc_payment":"পেমেণ্ট:",
        "bank_transfer":"✓ পোনপটীয়া বেংক ট্ৰান্সফাৰ","digital_status":"✓ ডিজিটেল পেমেণ্টৰ অৱস্থা","track_payment":"✓ ক্ৰয়ৰ পিছত পেমেণ্ট অনুসৰণ কৰক",
        "ai_quick_title":"🤖 AI সহায়কৰ দ্ৰুত প্ৰশ্ন","ai_quick_sub":"সহায় লাগে? KisanGati-ক সুধক",
        "ai_q1":"মই কেনেকৈ স্লট বুক কৰিম?","ai_q2":"মই কেতিয়া আহিব লাগে?","ai_q3":"মোৰ শস্য ক'ত আছে?","ai_q4":"মই পেমেণ্ট কেনেকৈ চাম?",
        "indicative_note":"সূচকীয় হাৰ ক্ৰয় কেন্দ্ৰই আপডেট কৰে।"
    },
    "te": {
        "centre_card_title":"📍 సమీప కొనుగోలు కేంద్రం","centre_name":"కిసాన్ కొనుగోలు కేంద్రం",
        "centre_distance":"దూరం: 4.2 కి.మీ","centre_open":"ఈరోజు తెరిచి ఉంది","centre_hours":"ఉదయం 10:00 – సాయంత్రం 5:00",
        "view_location":"స్థానాన్ని చూడండి","proc_info_title":"💰 కొనుగోలు సమాచారం","proc_crop":"పంట",
        "proc_rate":"నేటి సూచిక ధర:","per_quintal":" / క్వింటాల్","proc_payment":"చెల్లింపు:",
        "bank_transfer":"✓ నేరుగా బ్యాంక్ బదిలీ","digital_status":"✓ డిజిటల్ చెల్లింపు స్థితి","track_payment":"✓ కొనుగోలు తర్వాత చెల్లింపును ట్రాక్ చేయండి",
        "ai_quick_title":"🤖 AI సహాయకుడి త్వరిత ప్రశ్నలు","ai_quick_sub":"సహాయం కావాలా? KisanGatiని అడగండి",
        "ai_q1":"నేను స్లాట్‌ను ఎలా బుక్ చేయాలి?","ai_q2":"నేను ఎప్పుడు చేరాలి?","ai_q3":"నా పంట ఎక్కడ ఉంది?","ai_q4":"చెల్లింపును ఎలా తనిఖీ చేయాలి?",
        "indicative_note":"సూచిక ధరను కొనుగోలు కేంద్రం అప్‌డేట్ చేస్తుంది."
    },
    "mr": {
        "centre_card_title":"📍 जवळचे खरेदी केंद्र","centre_name":"किसान खरेदी केंद्र",
        "centre_distance":"अंतर: 4.2 किमी","centre_open":"आज खुले","centre_hours":"सकाळी 10:00 – संध्याकाळी 5:00",
        "view_location":"स्थान पहा","proc_info_title":"💰 खरेदी माहिती","proc_crop":"पीक",
        "proc_rate":"आजचा सूचक दर:","per_quintal":" / क्विंटल","proc_payment":"पेमेंट:",
        "bank_transfer":"✓ थेट बँक ट्रान्सफर","digital_status":"✓ डिजिटल पेमेंट स्थिती","track_payment":"✓ खरेदीनंतर पेमेंट ट्रॅक करा",
        "ai_quick_title":"🤖 AI सहाय्यकाचे झटपट प्रश्न","ai_quick_sub":"मदत हवी आहे? KisanGati ला विचारा",
        "ai_q1":"मी स्लॉट कसा बुक करू?","ai_q2":"मी कधी पोहोचावे?","ai_q3":"माझे उत्पादन कुठे आहे?","ai_q4":"मी पेमेंट कसे तपासू?",
        "indicative_note":"सूचक दर खरेदी केंद्राकडून अपडेट केला जातो."
    },
    "gu": {
        "centre_card_title":"📍 નજીકનું ખરીદી કેન્દ્ર","centre_name":"કિસાન ખરીદી કેન્દ્ર",
        "centre_distance":"અંતર: 4.2 કિમી","centre_open":"આજે ખુલ્લું","centre_hours":"સવારે 10:00 – સાંજે 5:00",
        "view_location":"સ્થાન જુઓ","proc_info_title":"💰 ખરીદી માહિતી","proc_crop":"પાક",
        "proc_rate":"આજનો સૂચક દર:","per_quintal":" / ક્વિન્ટલ","proc_payment":"ચુકવણી:",
        "bank_transfer":"✓ સીધી બેંક ટ્રાન્સફર","digital_status":"✓ ડિજિટલ ચુકવણી સ્થિતિ","track_payment":"✓ ખરીદી પછી ચુકવણી ટ્રૅક કરો",
        "ai_quick_title":"🤖 AI સહાયકના ઝડપી પ્રશ્નો","ai_quick_sub":"મદદ જોઈએ? KisanGati ને પૂછો",
        "ai_q1":"હું સ્લોટ કેવી રીતે બુક કરું?","ai_q2":"મારે ક્યારે પહોંચવું?","ai_q3":"મારો પાક ક્યાં છે?","ai_q4":"હું ચુકવણી કેવી રીતે તપાસું?",
        "indicative_note":"સૂચક દર ખરીદી કેન્દ્ર દ્વારા અપડેટ થાય છે."
    },
    "kn": {
        "centre_card_title":"📍 ಹತ್ತಿರದ ಖರೀದಿ ಕೇಂದ್ರ","centre_name":"ಕಿಸಾನ್ ಖರೀದಿ ಕೇಂದ್ರ",
        "centre_distance":"ದೂರ: 4.2 ಕಿ.ಮೀ","centre_open":"ಇಂದು ತೆರೆದಿದೆ","centre_hours":"ಬೆಳಿಗ್ಗೆ 10:00 – ಸಂಜೆ 5:00",
        "view_location":"ಸ್ಥಳ ವೀಕ್ಷಿಸಿ","proc_info_title":"💰 ಖರೀದಿ ಮಾಹಿತಿ","proc_crop":"ಬೆಳೆ",
        "proc_rate":"ಇಂದಿನ ಸೂಚಕ ದರ:","per_quintal":" / ಕ್ವಿಂಟಲ್","proc_payment":"ಪಾವತಿ:",
        "bank_transfer":"✓ ನೇರ ಬ್ಯಾಂಕ್ ವರ್ಗಾವಣೆ","digital_status":"✓ ಡಿಜಿಟಲ್ ಪಾವತಿ ಸ್ಥಿತಿ","track_payment":"✓ ಖರೀದಿಯ ನಂತರ ಪಾವತಿಯನ್ನು ಟ್ರ್ಯಾಕ್ ಮಾಡಿ",
        "ai_quick_title":"🤖 AI ಸಹಾಯಕ ತ್ವರಿತ ಪ್ರಶ್ನೆಗಳು","ai_quick_sub":"ಸಹಾಯ ಬೇಕೇ? KisanGatiಗೆ ಕೇಳಿ",
        "ai_q1":"ಸ್ಲಾಟ್ ಅನ್ನು ಹೇಗೆ ಬುಕ್ ಮಾಡುವುದು?","ai_q2":"ನಾನು ಯಾವಾಗ ತಲುಪಬೇಕು?","ai_q3":"ನನ್ನ ಬೆಳೆ ಎಲ್ಲಿದೆ?","ai_q4":"ಪಾವತಿಯನ್ನು ಹೇಗೆ ಪರಿಶೀಲಿಸಬೇಕು?",
        "indicative_note":"ಸೂಚಕ ದರವನ್ನು ಖರೀದಿ ಕೇಂದ್ರವು ನವೀಕರಿಸುತ್ತದೆ."
    },
    "ml": {
        "centre_card_title":"📍 അടുത്തുള്ള വാങ്ങൽ കേന്ദ്രം","centre_name":"കിസാൻ വാങ്ങൽ കേന്ദ്രം",
        "centre_distance":"ദൂരം: 4.2 കി.മീ","centre_open":"ഇന്ന് തുറന്നിരിക്കുന്നു","centre_hours":"രാവിലെ 10:00 – വൈകുന്നേരം 5:00",
        "view_location":"സ്ഥലം കാണുക","proc_info_title":"💰 വാങ്ങൽ വിവരം","proc_crop":"വിള",
        "proc_rate":"ഇന്നത്തെ സൂചിക നിരക്ക്:","per_quintal":" / ക്വിന്റൽ","proc_payment":"പേയ്മെന്റ്:",
        "bank_transfer":"✓ നേരിട്ടുള്ള ബാങ്ക് ട്രാൻസ്ഫർ","digital_status":"✓ ഡിജിറ്റൽ പേയ്മെന്റ് നില","track_payment":"✓ വാങ്ങലിന് ശേഷം പേയ്മെന്റ് ട്രാക്ക് ചെയ്യുക",
        "ai_quick_title":"🤖 AI സഹായിയുടെ ദ്രുത ചോദ്യങ്ങൾ","ai_quick_sub":"സഹായം വേണോ? KisanGati-യോട് ചോദിക്കൂ",
        "ai_q1":"സ്ലോട്ട് എങ്ങനെ ബുക്ക് ചെയ്യാം?","ai_q2":"ഞാൻ എപ്പോൾ എത്തണം?","ai_q3":"എന്റെ വിള എവിടെയാണ്?","ai_q4":"പേയ്മെന്റ് എങ്ങനെ പരിശോധിക്കാം?",
        "indicative_note":"സൂചിക നിരക്ക് വാങ്ങൽ കേന്ദ്രം അപ്ഡേറ്റ് ചെയ്യുന്നു."
    },
    "or": {
        "centre_card_title":"📍 ନିକଟତମ କ୍ରୟ କେନ୍ଦ୍ର","centre_name":"କିସାନ କ୍ରୟ କେନ୍ଦ୍ର",
        "centre_distance":"ଦୂରତା: 4.2 କିମି","centre_open":"ଆଜି ଖୋଲା ଅଛି","centre_hours":"ସକାଳ 10:00 – ସନ୍ଧ୍ୟା 5:00",
        "view_location":"ଅବସ୍ଥାନ ଦେଖନ୍ତୁ","proc_info_title":"💰 କ୍ରୟ ସୂଚନା","proc_crop":"ଫସଲ",
        "proc_rate":"ଆଜିର ସୂଚକ ଦର:","per_quintal":" / କୁଇଣ୍ଟାଲ୍","proc_payment":"ପେମେଣ୍ଟ:",
        "bank_transfer":"✓ ସିଧାସଳଖ ବ୍ୟାଙ୍କ ଟ୍ରାନ୍ସଫର","digital_status":"✓ ଡିଜିଟାଲ୍ ପେମେଣ୍ଟ ସ୍ଥିତି","track_payment":"✓ କ୍ରୟ ପରେ ପେମେଣ୍ଟ ଟ୍ରାକ୍ କରନ୍ତୁ",
        "ai_quick_title":"🤖 AI ସହାୟକ ଦ୍ରୁତ ପ୍ରଶ୍ନ","ai_quick_sub":"ସାହାଯ୍ୟ ଦରକାର? KisanGatiକୁ ପଚାରନ୍ତୁ",
        "ai_q1":"ମୁଁ କିପରି ସ୍ଲଟ୍ ବୁକ୍ କରିବି?","ai_q2":"ମୁଁ କେବେ ପହଞ୍ଚିବି?","ai_q3":"ମୋର ଫସଲ କେଉଁଠାରେ ଅଛି?","ai_q4":"ମୁଁ ପେମେଣ୍ଟ କିପରି ଯାଞ୍ଚ କରିବି?",
        "indicative_note":"ସୂଚକ ଦର କ୍ରୟ କେନ୍ଦ୍ର ଦ୍ୱାରା ଅପଡେଟ୍ କରାଯାଏ।"
    },
    "pa": {
        "centre_card_title":"📍 ਨੇੜਲਾ ਖਰੀਦ ਕੇਂਦਰ","centre_name":"ਕਿਸਾਨ ਖਰੀਦ ਕੇਂਦਰ",
        "centre_distance":"ਦੂਰੀ: 4.2 ਕਿਲੋਮੀਟਰ","centre_open":"ਅੱਜ ਖੁੱਲ੍ਹਾ","centre_hours":"ਸਵੇਰੇ 10:00 – ਸ਼ਾਮ 5:00",
        "view_location":"ਸਥਾਨ ਵੇਖੋ","proc_info_title":"💰 ਖਰੀਦ ਜਾਣਕਾਰੀ","proc_crop":"ਫਸਲ",
        "proc_rate":"ਅੱਜ ਦੀ ਸੰਕੇਤਕ ਦਰ:","per_quintal":" / ਕੁਇੰਟਲ","proc_payment":"ਭੁਗਤਾਨ:",
        "bank_transfer":"✓ ਸਿੱਧਾ ਬੈਂਕ ਟ੍ਰਾਂਸਫਰ","digital_status":"✓ ਡਿਜ਼ਿਟਲ ਭੁਗਤਾਨ ਸਥਿਤੀ","track_payment":"✓ ਖਰੀਦ ਤੋਂ ਬਾਅਦ ਭੁਗਤਾਨ ਟ੍ਰੈਕ ਕਰੋ",
        "ai_quick_title":"🤖 AI ਸਹਾਇਕ ਦੇ ਤੁਰੰਤ ਸਵਾਲ","ai_quick_sub":"ਮਦਦ ਚਾਹੀਦੀ ਹੈ? KisanGati ਨੂੰ ਪੁੱਛੋ",
        "ai_q1":"ਮੈਂ ਸਲਾਟ ਕਿਵੇਂ ਬੁੱਕ ਕਰਾਂ?","ai_q2":"ਮੈਨੂੰ ਕਦੋਂ ਪਹੁੰਚਣਾ ਚਾਹੀਦਾ ਹੈ?","ai_q3":"ਮੇਰੀ ਫਸਲ ਕਿੱਥੇ ਹੈ?","ai_q4":"ਮੈਂ ਭੁਗਤਾਨ ਕਿਵੇਂ ਚੈੱਕ ਕਰਾਂ?",
        "indicative_note":"ਸੰਕੇਤਕ ਦਰ ਖਰੀਦ ਕੇਂਦਰ ਵੱਲੋਂ ਅਪਡੇਟ ਕੀਤੀ ਜਾਂਦੀ ਹੈ।"
    }
}
for _code, _vals in _FARMER_PORTAL_CARDS.items():
    TRANSLATIONS[_code].update(_vals)

LOGIN_TRANSLATIONS = {'en': {'welcome': 'Welcome to KisanGati', 'sub': 'Select your access type to continue.', 'farmer': '👨\u200d🌾 Farmer', 'admin': '🛡️ Admin', 'mobile_label': 'Registered Mobile Number', 'mobile_ph': '10-digit mobile number', 'token_label': 'Digital Token', 'token_ph': 'e.g. P101', 'farmer_btn': 'Login as Farmer', 'new_farmer': 'New Farmer? Register Here', 'farmer_note': 'Farmers log in using the mobile number and digital token received after registration.', 'admin_user': 'Admin Username', 'admin_user_ph': 'Admin username', 'password': 'Password', 'password_ph': 'Admin password', 'admin_btn': 'Login as Admin', 'admin_note': 'Demo admin credentials: <b>admin</b> / <b>admin123</b>.', 'language': 'Language', 'brand_desc': 'Smart Agricultural Procurement & Farmer Assistance Platform', 'p1': '📅 Smart slot booking', 'p2': '🎟️ Digital token & live queue', 'p3': '📍 Procurement & shipment tracking', 'p4': '💳 Transparent payment status', 'admin_err': 'Invalid admin username or password.', 'farmer_err': 'Invalid mobile number or digital token. If you are a new farmer, register first.'}, 'hi': {'welcome': 'KisanGati में आपका स्वागत है', 'sub': 'जारी रखने के लिए अपना एक्सेस प्रकार चुनें।', 'farmer': '👨\u200d🌾 किसान', 'admin': '🛡️ एडमिन', 'mobile_label': 'पंजीकृत मोबाइल नंबर', 'mobile_ph': '10 अंकों का मोबाइल नंबर', 'token_label': 'डिजिटल टोकन', 'token_ph': 'जैसे P101', 'farmer_btn': 'किसान के रूप में लॉगिन करें', 'new_farmer': 'नए किसान? यहां पंजीकरण करें', 'farmer_note': 'पंजीकरण के बाद मिले मोबाइल नंबर और डिजिटल टोकन से किसान लॉगिन कर सकते हैं।', 'admin_user': 'एडमिन यूज़रनेम', 'admin_user_ph': 'एडमिन यूज़रनेम', 'password': 'पासवर्ड', 'password_ph': 'एडमिन पासवर्ड', 'admin_btn': 'एडमिन के रूप में लॉगिन करें', 'admin_note': 'डेमो एडमिन क्रेडेंशियल: <b>admin</b> / <b>admin123</b>.', 'language': 'भाषा', 'brand_desc': 'स्मार्ट कृषि खरीद और किसान सहायता प्लेटफॉर्म', 'p1': '📅 स्मार्ट स्लॉट बुकिंग', 'p2': '🎟️ डिजिटल टोकन और लाइव कतार', 'p3': '📍 खरीद और शिपमेंट ट्रैकिंग', 'p4': '💳 पारदर्शी भुगतान स्थिति', 'admin_err': 'अमान्य एडमिन यूज़रनेम या पासवर्ड।', 'farmer_err': 'मोबाइल नंबर या डिजिटल टोकन अमान्य है। यदि आप नए किसान हैं, पहले पंजीकरण करें।'}, 'bn': {'welcome': 'KisanGati-তে স্বাগতম', 'sub': 'চালিয়ে যেতে আপনার অ্যাক্সেসের ধরন নির্বাচন করুন।', 'farmer': '👨\u200d🌾 কৃষক', 'admin': '🛡️ অ্যাডমিন', 'mobile_label': 'নিবন্ধিত মোবাইল নম্বর', 'mobile_ph': '১০ সংখ্যার মোবাইল নম্বর', 'token_label': 'ডিজিটাল টোকেন', 'token_ph': 'যেমন P101', 'farmer_btn': 'কৃষক হিসেবে লগইন করুন', 'new_farmer': 'নতুন কৃষক? এখানে নিবন্ধন করুন', 'farmer_note': 'নিবন্ধনের পর পাওয়া মোবাইল নম্বর ও ডিজিটাল টোকেন দিয়ে কৃষক লগইন করতে পারেন।', 'admin_user': 'অ্যাডমিন ইউজারনেম', 'admin_user_ph': 'অ্যাডমিন ইউজারনেম', 'password': 'পাসওয়ার্ড', 'password_ph': 'অ্যাডমিন পাসওয়ার্ড', 'admin_btn': 'অ্যাডমিন হিসেবে লগইন করুন', 'admin_note': 'ডেমো অ্যাডমিন ক্রেডেনশিয়াল: <b>admin</b> / <b>admin123</b>.', 'language': 'ভাষা', 'brand_desc': 'স্মার্ট কৃষি ক্রয় ও কৃষক সহায়তা প্ল্যাটফর্ম', 'p1': '📅 স্মার্ট স্লট বুকিং', 'p2': '🎟️ ডিজিটাল টোকেন ও লাইভ সারি', 'p3': '📍 ক্রয় ও শিপমেন্ট ট্র্যাকিং', 'p4': '💳 স্বচ্ছ পেমেন্টের অবস্থা', 'admin_err': 'অবৈধ অ্যাডমিন ইউজারনেম বা পাসওয়ার্ড।', 'farmer_err': 'মোবাইল নম্বর বা ডিজিটাল টোকেন সঠিক নয়। নতুন কৃষক হলে আগে নিবন্ধন করুন।'}, 'ta': {'welcome': 'KisanGati-க்கு வரவேற்கிறோம்', 'sub': 'தொடர உங்கள் அணுகல் வகையைத் தேர்ந்தெடுக்கவும்.', 'farmer': '👨\u200d🌾 விவசாயி', 'admin': '🛡️ நிர்வாகி', 'mobile_label': 'பதிவுசெய்த மொபைல் எண்', 'mobile_ph': '10 இலக்க மொபைல் எண்', 'token_label': 'டிஜிட்டல் டோக்கன்', 'token_ph': 'எ.கா. P101', 'farmer_btn': 'விவசாயியாக உள்நுழைக', 'new_farmer': 'புதிய விவசாயியா? இங்கே பதிவு செய்யவும்', 'farmer_note': 'பதிவுக்குப் பிறகு பெறப்பட்ட மொபைல் எண் மற்றும் டிஜிட்டல் டோக்கன் மூலம் விவசாயிகள் உள்நுழையலாம்.', 'admin_user': 'நிர்வாகி பயனர்பெயர்', 'admin_user_ph': 'நிர்வாகி பயனர்பெயர்', 'password': 'கடவுச்சொல்', 'password_ph': 'நிர்வாகி கடவுச்சொல்', 'admin_btn': 'நிர்வாகியாக உள்நுழைக', 'admin_note': 'டெமோ நிர்வாகி சான்றுகள்: <b>admin</b> / <b>admin123</b>.', 'language': 'மொழி', 'brand_desc': 'ஸ்மார்ட் வேளாண் கொள்முதல் மற்றும் விவசாயி உதவி தளம்', 'p1': '📅 ஸ்மார்ட் ஸ்லாட் முன்பதிவு', 'p2': '🎟️ டிஜிட்டல் டோக்கன் & நேரடி வரிசை', 'p3': '📍 கொள்முதல் & அனுப்புதல் கண்காணிப்பு', 'p4': '💳 வெளிப்படையான பணப்பரிவர்த்தனை நிலை', 'admin_err': 'தவறான நிர்வாகி பயனர்பெயர் அல்லது கடவுச்சொல்.', 'farmer_err': 'மொபைல் எண் அல்லது டிஜிட்டல் டோக்கன் தவறானது. புதிய விவசாயி என்றால் முதலில் பதிவு செய்யவும்.'}, 'as': {'welcome': 'KisanGati লৈ স্বাগতম', 'sub': 'আগবাঢ়িবলৈ আপোনাৰ প্ৰৱেশৰ ধৰণ বাছনি কৰক।', 'farmer': '👨\u200d🌾 কৃষক', 'admin': '🛡️ এডমিন', 'mobile_label': 'পঞ্জীয়ন কৰা মোবাইল নম্বৰ', 'mobile_ph': '১০ সংখ্যাৰ মোবাইল নম্বৰ', 'token_label': 'ডিজিটেল টোকেন', 'token_ph': 'উদাহৰণ P101', 'farmer_btn': 'কৃষক হিচাপে লগইন কৰক', 'new_farmer': 'নতুন কৃষক? ইয়াত পঞ্জীয়ন কৰক', 'farmer_note': 'পঞ্জীয়নৰ পিছত পোৱা মোবাইল নম্বৰ আৰু ডিজিটেল টোকেন ব্যৱহাৰ কৰি কৃষকে লগইন কৰিব পাৰে।', 'admin_user': 'এডমিন ইউজাৰনেম', 'admin_user_ph': 'এডমিন ইউজাৰনেম', 'password': 'পাছৱৰ্ড', 'password_ph': 'এডমিন পাছৱৰ্ড', 'admin_btn': 'এডমিন হিচাপে লগইন কৰক', 'admin_note': 'ডেমো এডমিন ক্ৰেডেনচিয়েল: <b>admin</b> / <b>admin123</b>.', 'language': 'ভাষা', 'brand_desc': 'স্মাৰ্ট কৃষি ক্ৰয় আৰু কৃষক সহায়তা প্লেটফৰ্ম', 'p1': '📅 স্মাৰ্ট স্লট বুকিং', 'p2': '🎟️ ডিজিটেল টোকেন আৰু লাইভ শাৰী', 'p3': '📍 ক্ৰয় আৰু শিপমেণ্ট অনুসৰণ', 'p4': '💳 স্বচ্ছ পেমেণ্টৰ অৱস্থা', 'admin_err': 'অবৈধ এডমিন ইউজাৰনেম বা পাছৱৰ্ড।', 'farmer_err': 'মোবাইল নম্বৰ বা ডিজিটেল টোকেন ভুল। নতুন কৃষক হলে প্ৰথমে পঞ্জীয়ন কৰক।'}, 'te': {'welcome': 'KisanGatiకి స్వాగతం', 'sub': 'కొనసాగించడానికి మీ యాక్సెస్ రకాన్ని ఎంచుకోండి.', 'farmer': '👨\u200d🌾 రైతు', 'admin': '🛡️ అడ్మిన్', 'mobile_label': 'నమోదు చేసిన మొబైల్ నంబర్', 'mobile_ph': '10 అంకెల మొబైల్ నంబర్', 'token_label': 'డిజిటల్ టోకెన్', 'token_ph': 'ఉదా. P101', 'farmer_btn': 'రైతుగా లాగిన్ అవ్వండి', 'new_farmer': 'కొత్త రైతువా? ఇక్కడ నమోదు చేసుకోండి', 'farmer_note': 'నమోదు తర్వాత పొందిన మొబైల్ నంబర్ మరియు డిజిటల్ టోకెన్\u200cతో రైతులు లాగిన్ అవ్వవచ్చు.', 'admin_user': 'అడ్మిన్ యూజర్\u200cనేమ్', 'admin_user_ph': 'అడ్మిన్ యూజర్\u200cనేమ్', 'password': 'పాస్\u200cవర్డ్', 'password_ph': 'అడ్మిన్ పాస్\u200cవర్డ్', 'admin_btn': 'అడ్మిన్\u200cగా లాగిన్ అవ్వండి', 'admin_note': 'డెమో అడ్మిన్ ఆధారాలు: <b>admin</b> / <b>admin123</b>.', 'language': 'భాష', 'brand_desc': 'స్మార్ట్ వ్యవసాయ కొనుగోలు & రైతు సహాయ వేదిక', 'p1': '📅 స్మార్ట్ స్లాట్ బుకింగ్', 'p2': '🎟️ డిజిటల్ టోకెన్ & లైవ్ క్యూ', 'p3': '📍 కొనుగోలు & షిప్\u200cమెంట్ ట్రాకింగ్', 'p4': '💳 పారదర్శక చెల్లింపు స్థితి', 'admin_err': 'చెల్లని అడ్మిన్ యూజర్\u200cనేమ్ లేదా పాస్\u200cవర్డ్.', 'farmer_err': 'మొబైల్ నంబర్ లేదా డిజిటల్ టోకెన్ చెల్లదు. మీరు కొత్త రైతు అయితే ముందుగా నమోదు చేసుకోండి.'}, 'mr': {'welcome': 'KisanGati मध्ये आपले स्वागत आहे', 'sub': 'पुढे जाण्यासाठी तुमचा प्रवेश प्रकार निवडा.', 'farmer': '👨\u200d🌾 शेतकरी', 'admin': '🛡️ प्रशासक', 'mobile_label': 'नोंदणीकृत मोबाईल नंबर', 'mobile_ph': '10 अंकी मोबाईल नंबर', 'token_label': 'डिजिटल टोकन', 'token_ph': 'उदा. P101', 'farmer_btn': 'शेतकरी म्हणून लॉगिन करा', 'new_farmer': 'नवीन शेतकरी? येथे नोंदणी करा', 'farmer_note': 'नोंदणीनंतर मिळालेल्या मोबाईल नंबर आणि डिजिटल टोकनने शेतकरी लॉगिन करू शकतात.', 'admin_user': 'प्रशासक युजरनेम', 'admin_user_ph': 'प्रशासक युजरनेम', 'password': 'पासवर्ड', 'password_ph': 'प्रशासक पासवर्ड', 'admin_btn': 'प्रशासक म्हणून लॉगिन करा', 'admin_note': 'डेमो प्रशासक क्रेडेन्शियल: <b>admin</b> / <b>admin123</b>.', 'language': 'भाषा', 'brand_desc': 'स्मार्ट कृषी खरेदी आणि शेतकरी सहाय्य प्लॅटफॉर्म', 'p1': '📅 स्मार्ट स्लॉट बुकिंग', 'p2': '🎟️ डिजिटल टोकन आणि लाइव्ह रांग', 'p3': '📍 खरेदी आणि शिपमेंट ट्रॅकिंग', 'p4': '💳 पारदर्शक पेमेंट स्थिती', 'admin_err': 'अवैध प्रशासक युजरनेम किंवा पासवर्ड.', 'farmer_err': 'मोबाईल नंबर किंवा डिजिटल टोकन अवैध आहे. नवीन शेतकरी असल्यास प्रथम नोंदणी करा.'}, 'gu': {'welcome': 'KisanGati માં આપનું સ્વાગત છે', 'sub': 'ચાલુ રાખવા માટે તમારો ઍક્સેસ પ્રકાર પસંદ કરો.', 'farmer': '👨\u200d🌾 ખેડૂત', 'admin': '🛡️ એડમિન', 'mobile_label': 'નોંધાયેલ મોબાઇલ નંબર', 'mobile_ph': '10 અંકનો મોબાઇલ નંબર', 'token_label': 'ડિજિટલ ટોકન', 'token_ph': 'દા.ત. P101', 'farmer_btn': 'ખેડૂત તરીકે લૉગિન કરો', 'new_farmer': 'નવા ખેડૂત છો? અહીં નોંધણી કરો', 'farmer_note': 'નોંધણી પછી મળેલા મોબાઇલ નંબર અને ડિજિટલ ટોકનથી ખેડૂત લૉગિન કરી શકે છે.', 'admin_user': 'એડમિન યુઝરનેમ', 'admin_user_ph': 'એડમિન યુઝરનેમ', 'password': 'પાસવર્ડ', 'password_ph': 'એડમિન પાસવર્ડ', 'admin_btn': 'એડમિન તરીકે લૉગિન કરો', 'admin_note': 'ડેમો એડમિન ક્રેડેન્શિયલ: <b>admin</b> / <b>admin123</b>.', 'language': 'ભાષા', 'brand_desc': 'સ્માર્ટ કૃષિ ખરીદી અને ખેડૂત સહાય પ્લેટફોર્મ', 'p1': '📅 સ્માર્ટ સ્લોટ બુકિંગ', 'p2': '🎟️ ડિજિટલ ટોકન અને લાઇવ કતાર', 'p3': '📍 ખરીદી અને શિપમેન્ટ ટ્રેકિંગ', 'p4': '💳 પારદર્શક ચુકવણી સ્થિતિ', 'admin_err': 'અમાન્ય એડમિન યુઝરનેમ અથવા પાસવર્ડ.', 'farmer_err': 'મોબાઇલ નંબર અથવા ડિજિટલ ટોકન અમાન્ય છે. નવા ખેડૂત હો તો પહેલા નોંધણી કરો.'}, 'kn': {'welcome': 'KisanGati ಗೆ ಸ್ವಾಗತ', 'sub': 'ಮುಂದುವರಿಯಲು ನಿಮ್ಮ ಪ್ರವೇಶದ ಪ್ರಕಾರವನ್ನು ಆಯ್ಕೆಮಾಡಿ.', 'farmer': '👨\u200d🌾 ರೈತ', 'admin': '🛡️ ನಿರ್ವಾಹಕ', 'mobile_label': 'ನೋಂದಾಯಿತ ಮೊಬೈಲ್ ಸಂಖ್ಯೆ', 'mobile_ph': '10 ಅಂಕಿಯ ಮೊಬೈಲ್ ಸಂಖ್ಯೆ', 'token_label': 'ಡಿಜಿಟಲ್ ಟೋಕನ್', 'token_ph': 'ಉದಾ. P101', 'farmer_btn': 'ರೈತರಾಗಿ ಲಾಗಿನ್ ಮಾಡಿ', 'new_farmer': 'ಹೊಸ ರೈತರೇ? ಇಲ್ಲಿ ನೋಂದಣಿ ಮಾಡಿ', 'farmer_note': 'ನೋಂದಣಿಯ ನಂತರ ಪಡೆದ ಮೊಬೈಲ್ ಸಂಖ್ಯೆ ಮತ್ತು ಡಿಜಿಟಲ್ ಟೋಕನ್ ಬಳಸಿ ರೈತರು ಲಾಗಿನ್ ಮಾಡಬಹುದು.', 'admin_user': 'ನಿರ್ವಾಹಕ ಬಳಕೆದಾರಹೆಸರು', 'admin_user_ph': 'ನಿರ್ವಾಹಕ ಬಳಕೆದಾರಹೆಸರು', 'password': 'ಪಾಸ್\u200cವರ್ಡ್', 'password_ph': 'ನಿರ್ವಾಹಕ ಪಾಸ್\u200cವರ್ಡ್', 'admin_btn': 'ನಿರ್ವಾಹಕರಾಗಿ ಲಾಗಿನ್ ಮಾಡಿ', 'admin_note': 'ಡೆಮೋ ನಿರ್ವಾಹಕ ವಿವರಗಳು: <b>admin</b> / <b>admin123</b>.', 'language': 'ಭಾಷೆ', 'brand_desc': 'ಸ್ಮಾರ್ಟ್ ಕೃಷಿ ಖರೀದಿ ಮತ್ತು ರೈತ ಸಹಾಯ ವೇದಿಕೆ', 'p1': '📅 ಸ್ಮಾರ್ಟ್ ಸ್ಲಾಟ್ ಬುಕ್ಕಿಂಗ್', 'p2': '🎟️ ಡಿಜಿಟಲ್ ಟೋಕನ್ ಮತ್ತು ಲೈವ್ ಸರದಿ', 'p3': '📍 ಖರೀದಿ ಮತ್ತು ಶಿಪ್\u200cಮೆಂಟ್ ಟ್ರ್ಯಾಕಿಂಗ್', 'p4': '💳 ಪಾರದರ್ಶಕ ಪಾವತಿ ಸ್ಥಿತಿ', 'admin_err': 'ಅಮಾನ್ಯ ನಿರ್ವಾಹಕ ಬಳಕೆದಾರಹೆಸರು ಅಥವಾ ಪಾಸ್\u200cವರ್ಡ್.', 'farmer_err': 'ಮೊಬೈಲ್ ಸಂಖ್ಯೆ ಅಥವಾ ಡಿಜಿಟಲ್ ಟೋಕನ್ ಅಮಾನ್ಯವಾಗಿದೆ. ಹೊಸ ರೈತರಾಗಿದ್ದರೆ ಮೊದಲು ನೋಂದಣಿ ಮಾಡಿ.'}, 'ml': {'welcome': 'KisanGati-ലേക്ക് സ്വാഗതം', 'sub': 'തുടരാൻ നിങ്ങളുടെ ആക്സസ് തരം തിരഞ്ഞെടുക്കുക.', 'farmer': '👨\u200d🌾 കർഷകൻ', 'admin': '🛡️ അഡ്മിൻ', 'mobile_label': 'രജിസ്റ്റർ ചെയ്ത മൊബൈൽ നമ്പർ', 'mobile_ph': '10 അക്ക മൊബൈൽ നമ്പർ', 'token_label': 'ഡിജിറ്റൽ ടോക്കൺ', 'token_ph': 'ഉദാ. P101', 'farmer_btn': 'കർഷകനായി ലോഗിൻ ചെയ്യുക', 'new_farmer': 'പുതിയ കർഷകനാണോ? ഇവിടെ രജിസ്റ്റർ ചെയ്യുക', 'farmer_note': 'രജിസ്ട്രേഷനുശേഷം ലഭിച്ച മൊബൈൽ നമ്പറും ഡിജിറ്റൽ ടോക്കണും ഉപയോഗിച്ച് കർഷകർക്ക് ലോഗിൻ ചെയ്യാം.', 'admin_user': 'അഡ്മിൻ യൂസർനെയിം', 'admin_user_ph': 'അഡ്മിൻ യൂസർനെയിം', 'password': 'പാസ്\u200cവേഡ്', 'password_ph': 'അഡ്മിൻ പാസ്\u200cവേഡ്', 'admin_btn': 'അഡ്മിനായി ലോഗിൻ ചെയ്യുക', 'admin_note': 'ഡെമോ അഡ്മിൻ ക്രെഡൻഷ്യലുകൾ: <b>admin</b> / <b>admin123</b>.', 'language': 'ഭാഷ', 'brand_desc': 'സ്മാർട്ട് കാർഷിക വാങ്ങലും കർഷക സഹായ പ്ലാറ്റ്ഫോമും', 'p1': '📅 സ്മാർട്ട് സ്ലോട്ട് ബുക്കിംഗ്', 'p2': '🎟️ ഡിജിറ്റൽ ടോക്കൺ & ലൈവ് ക്യൂ', 'p3': '📍 വാങ്ങൽ & ഷിപ്പ്മെന്റ് ട്രാക്കിംഗ്', 'p4': '💳 സുതാര്യമായ പേയ്മെന്റ് നില', 'admin_err': 'അസാധുവായ അഡ്മിൻ യൂസർനെയിം അല്ലെങ്കിൽ പാസ്\u200cവേഡ്.', 'farmer_err': 'മൊബൈൽ നമ്പർ അല്ലെങ്കിൽ ഡിജിറ്റൽ ടോക്കൺ അസാധുവാണ്. പുതിയ കർഷകനാണെങ്കിൽ ആദ്യം രജിസ്റ്റർ ചെയ്യുക.'}, 'or': {'welcome': 'KisanGatiକୁ ସ୍ୱାଗତ', 'sub': 'ଜାରି ରଖିବା ପାଇଁ ଆପଣଙ୍କ ପ୍ରବେଶ ପ୍ରକାର ବାଛନ୍ତୁ।', 'farmer': '👨\u200d🌾 ଚାଷୀ', 'admin': '🛡️ ଆଡମିନ୍', 'mobile_label': 'ପଞ୍ଜୀକୃତ ମୋବାଇଲ୍ ନମ୍ବର', 'mobile_ph': '୧୦ ଅଙ୍କର ମୋବାଇଲ୍ ନମ୍ବର', 'token_label': 'ଡିଜିଟାଲ୍ ଟୋକେନ୍', 'token_ph': 'ଉଦାହରଣ P101', 'farmer_btn': 'ଚାଷୀ ଭାବେ ଲଗଇନ୍ କରନ୍ତୁ', 'new_farmer': 'ନୂଆ ଚାଷୀ? ଏଠାରେ ପଞ୍ଜୀକରଣ କରନ୍ତୁ', 'farmer_note': 'ପଞ୍ଜୀକରଣ ପରେ ପାଇଥିବା ମୋବାଇଲ୍ ନମ୍ବର ଏବଂ ଡିଜିଟାଲ୍ ଟୋକେନ୍ ଦ୍ୱାରା ଚାଷୀ ଲଗଇନ୍ କରିପାରିବେ।', 'admin_user': 'ଆଡମିନ୍ ୟୁଜରନେମ୍', 'admin_user_ph': 'ଆଡମିନ୍ ୟୁଜରନେମ୍', 'password': 'ପାସୱାର୍ଡ', 'password_ph': 'ଆଡମିନ୍ ପାସୱାର୍ଡ', 'admin_btn': 'ଆଡମିନ୍ ଭାବେ ଲଗଇନ୍ କରନ୍ତୁ', 'admin_note': 'ଡେମୋ ଆଡମିନ୍ ପ୍ରମାଣପତ୍ର: <b>admin</b> / <b>admin123</b>.', 'language': 'ଭାଷା', 'brand_desc': 'ସ୍ମାର୍ଟ କୃଷି କ୍ରୟ ଏବଂ ଚାଷୀ ସହାୟତା ପ୍ଲାଟଫର୍ମ', 'p1': '📅 ସ୍ମାର୍ଟ ସ୍ଲଟ୍ ବୁକିଂ', 'p2': '🎟️ ଡିଜିଟାଲ୍ ଟୋକେନ୍ ଏବଂ ଲାଇଭ୍ ଧାଡ଼ି', 'p3': '📍 କ୍ରୟ ଏବଂ ଶିପମେଣ୍ଟ ଟ୍ରାକିଂ', 'p4': '💳 ସ୍ୱଚ୍ଛ ପେମେଣ୍ଟ ସ୍ଥିତି', 'admin_err': 'ଅବୈଧ ଆଡମିନ୍ ୟୁଜରନେମ୍ କିମ୍ବା ପାସୱାର୍ଡ।', 'farmer_err': 'ମୋବାଇଲ୍ ନମ୍ବର କିମ୍ବା ଡିଜିଟାଲ୍ ଟୋକେନ୍ ଅବୈଧ। ଆପଣ ନୂଆ ଚାଷୀ ହେଲେ ପ୍ରଥମେ ପଞ୍ଜୀକରଣ କରନ୍ତୁ।'}, 'pa': {'welcome': 'KisanGati ਵਿੱਚ ਤੁਹਾਡਾ ਸਵਾਗਤ ਹੈ', 'sub': 'ਜਾਰੀ ਰੱਖਣ ਲਈ ਆਪਣੀ ਐਕਸੈੱਸ ਕਿਸਮ ਚੁਣੋ।', 'farmer': '👨\u200d🌾 ਕਿਸਾਨ', 'admin': '🛡️ ਐਡਮਿਨ', 'mobile_label': 'ਰਜਿਸਟਰਡ ਮੋਬਾਈਲ ਨੰਬਰ', 'mobile_ph': '10 ਅੰਕਾਂ ਦਾ ਮੋਬਾਈਲ ਨੰਬਰ', 'token_label': 'ਡਿਜ਼ਿਟਲ ਟੋਕਨ', 'token_ph': 'ਉਦਾਹਰਨ P101', 'farmer_btn': 'ਕਿਸਾਨ ਵਜੋਂ ਲੌਗਇਨ ਕਰੋ', 'new_farmer': 'ਨਵੇਂ ਕਿਸਾਨ ਹੋ? ਇੱਥੇ ਰਜਿਸਟਰ ਕਰੋ', 'farmer_note': 'ਰਜਿਸਟ੍ਰੇਸ਼ਨ ਤੋਂ ਬਾਅਦ ਮਿਲੇ ਮੋਬਾਈਲ ਨੰਬਰ ਅਤੇ ਡਿਜ਼ਿਟਲ ਟੋਕਨ ਨਾਲ ਕਿਸਾਨ ਲੌਗਇਨ ਕਰ ਸਕਦੇ ਹਨ।', 'admin_user': 'ਐਡਮਿਨ ਯੂਜ਼ਰਨੇਮ', 'admin_user_ph': 'ਐਡਮਿਨ ਯੂਜ਼ਰਨੇਮ', 'password': 'ਪਾਸਵਰਡ', 'password_ph': 'ਐਡਮਿਨ ਪਾਸਵਰਡ', 'admin_btn': 'ਐਡਮਿਨ ਵਜੋਂ ਲੌਗਇਨ ਕਰੋ', 'admin_note': 'ਡੈਮੋ ਐਡਮਿਨ ਕ੍ਰੈਡੈਂਸ਼ਲ: <b>admin</b> / <b>admin123</b>.', 'language': 'ਭਾਸ਼ਾ', 'brand_desc': 'ਸਮਾਰਟ ਖੇਤੀਬਾੜੀ ਖਰੀਦ ਅਤੇ ਕਿਸਾਨ ਸਹਾਇਤਾ ਪਲੇਟਫਾਰਮ', 'p1': '📅 ਸਮਾਰਟ ਸਲਾਟ ਬੁਕਿੰਗ', 'p2': '🎟️ ਡਿਜ਼ਿਟਲ ਟੋਕਨ ਅਤੇ ਲਾਈਵ ਕਤਾਰ', 'p3': '📍 ਖਰੀਦ ਅਤੇ ਸ਼ਿਪਮੈਂਟ ਟ੍ਰੈਕਿੰਗ', 'p4': '💳 ਪਾਰਦਰਸ਼ੀ ਭੁਗਤਾਨ ਸਥਿਤੀ', 'admin_err': 'ਅਵੈਧ ਐਡਮਿਨ ਯੂਜ਼ਰਨੇਮ ਜਾਂ ਪਾਸਵਰਡ।', 'farmer_err': 'ਮੋਬਾਈਲ ਨੰਬਰ ਜਾਂ ਡਿਜ਼ਿਟਲ ਟੋਕਨ ਗਲਤ ਹੈ। ਜੇ ਤੁਸੀਂ ਨਵੇਂ ਕਿਸਾਨ ਹੋ ਤਾਂ ਪਹਿਲਾਂ ਰਜਿਸਟਰ ਕਰੋ।'}}
...
<style>
*{box-sizing:border-box}body{margin:0;font-family:Inter,Arial,sans-serif;background:linear-gradient(135deg,#eef8f0,#f7fbf8);color:#183028;min-height:100vh;display:flex;align-items:center;justify-content:center}.wrap{width:min(1000px,94vw);display:grid;grid-template-columns:1.05fr .95fr;background:#fff;border-radius:24px;box-shadow:0 18px 55px rgba(0,80,45,.13);overflow:hidden}.brand{background:linear-gradient(145deg,#0b6b38,#149447);color:white;padding:58px 52px;display:flex;flex-direction:column;justify-content:center}.brand h1{font-size:44px;margin:0 0 14px}.brand p{font-size:18px;line-height:1.6;opacity:.93}.points{margin-top:26px;display:grid;gap:13px}.points div{padding:13px 15px;border:1px solid rgba(255,255,255,.25);border-radius:12px;background:rgba(255,255,255,.08)}.login{padding:42px}.login h2{margin:0 0 7px;font-size:29px;color:#145d37}.sub{color:#64746c;margin-bottom:25px}.role-tabs{display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:20px}.role-tabs button{padding:13px;border:1px solid #d7e2db;border-radius:11px;background:#f7faf8;font-weight:800;color:#315343;cursor:pointer}.role-tabs button.active{background:#0f6d3b;color:#fff;border-color:#0f6d3b}.panel{display:none}.panel.active{display:block}.field{margin:14px 0}.field label{display:block;font-weight:700;margin-bottom:7px}.field input,.lang{width:100%;padding:13px 14px;border:1px solid #cfdad3;border-radius:10px;font-size:15px}.btn{width:100%;padding:13px;border:0;border-radius:10px;background:#0f6d3b;color:#fff;font-weight:800;font-size:15px;cursor:pointer}.secondary{background:#eaf5ee;color:#0f6d3b;margin-top:10px}.note{font-size:12px;color:#748078;margin-top:12px;line-height:1.5}.flash{padding:10px 12px;border-radius:9px;background:#fff3cd;color:#765b00;margin-bottom:15px}@media(max-width:760px){.wrap{grid-template-columns:1fr}.brand{padding:32px}.login{padding:28px}}

.registration-success-card{margin:28px 0 10px;background:linear-gradient(135deg,#f0fdf4,#ffffff);border:1px solid #bbf7d0;border-radius:18px;padding:24px;box-shadow:0 8px 25px #16653412}
.registration-success-head{display:flex;align-items:center;gap:12px;margin-bottom:18px}
.registration-success-check{width:42px;height:42px;border-radius:50%;background:#166534;color:#fff;display:flex;align-items:center;justify-content:center;font-size:22px}
.registration-success-head h2{margin:0;color:#166534;font-size:25px}
.registration-success-sub{margin:4px 0 0;color:#64748b;font-size:13px}
.registration-token-box{background:#fff;border:2px dashed #86efac;border-radius:15px;text-align:center;padding:18px;margin:15px 0}
.registration-token-label{font-size:12px;color:#64748b;font-weight:700;text-transform:uppercase;letter-spacing:.08em}
.registration-token-value{font-size:44px;font-weight:900;letter-spacing:.08em;color:#166534;margin-top:4px}
.registration-success-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:10px;margin:14px 0}
.registration-success-grid>div{background:#fff;border:1px solid #e5e7eb;border-radius:10px;padding:10px}
.registration-success-grid small{display:block;color:#64748b;font-size:10px;margin-bottom:4px}
.registration-success-grid b{font-size:13px;word-break:break-word}
.registration-success-actions{display:flex;gap:10px;flex-wrap:wrap;margin-top:15px}
.registration-success-actions a{display:inline-block;text-decoration:none}
.registration-success-note{font-size:12px;color:#64748b;margin:12px 0 0;line-height:1.5}
@media(max-width:700px){.registration-success-grid{grid-template-columns:1fr 1fr}.registration-token-value{font-size:36px}}

</style></head><body>
<div class="wrap"><div class="brand"><div style="font-size:50px">🌾</div><h1>KisanGati</h1><p>{{ login_t.brand_desc }}</p><div class="points"><div>{{ login_t.p1 }}</div><div>{{ login_t.p2 }}</div><div>{{ login_t.p3 }}</div><div>{{ login_t.p4 }}</div></div></div>
<div class="login"><h2>{{ login_t.welcome }}</h2><p class="sub">{{ login_t.sub }}</p>
{% with messages=get_flashed_messages() %}{% if messages %}<div class="flash">{{messages[0]}}</div>{% endif %}{% endwith %}
<div class="role-tabs"><button id="farmerTab" class="active" onclick="showRole('farmer')">{{ login_t.farmer }}</button><button id="adminTab" onclick="showRole('admin')">{{ login_t.admin }}</button></div>
<div id="farmerPanel" class="panel active"><form method="POST" action="/login"><input type="hidden" name="role" value="farmer"><input type="hidden" name="language" value="{{ language }}"><div class="field"><label>{{ login_t.mobile_label }}</label><input name="mobile" inputmode="numeric" maxlength="10" required placeholder="{{ login_t.mobile_ph }}"></div><div class="field"><label>{{ login_t.token_label }}</label><input name="token" maxlength="4" required placeholder="{{ login_t.token_ph }}"></div><button class="btn">{{ login_t.farmer_btn }}</button></form><a href="/new-farmer?lang={{ language }}"><button class="btn secondary" type="button">{{ login_t.new_farmer }}</button></a><div class="note">{{ login_t.farmer_note }}</div></div>
<div id="adminPanel" class="panel"><form method="POST" action="/login"><input type="hidden" name="role" value="admin"><input type="hidden" name="language" value="{{ language }}"><div class="field"><label>{{ login_t.admin_user }}</label><input name="username" required placeholder="{{ login_t.admin_user_ph }}"></div><div class="field"><label>{{ login_t.password }}</label><input name="password" type="password" required placeholder="{{ login_t.password_ph }}"></div><button class="btn">{{ login_t.admin_btn }}</button></form><div class="note">{{ login_t.admin_note|safe }}</div></div>
<div style="margin-top:20px"><label style="font-weight:700;display:block;margin-bottom:7px">{{ login_t.language }}</label><select class="lang" onchange="location.href='/?lang='+this.value">
<option value="en" {% if language=='en' %}selected{% endif %}>English</option><option value="hi" {% if language=='hi' %}selected{% endif %}>हिन्दी</option><option value="bn" {% if language=='bn' %}selected{% endif %}>বাংলা</option><option value="ta" {% if language=='ta' %}selected{% endif %}>தமிழ்</option><option value="as" {% if language=='as' %}selected{% endif %}>অসমীয়া</option><option value="te" {% if language=='te' %}selected{% endif %}>తెలుగు</option><option value="mr" {% if language=='mr' %}selected{% endif %}>मराठी</option><option value="gu" {% if language=='gu' %}selected{% endif %}>ગુજરાતી</option><option value="kn" {% if language=='kn' %}selected{% endif %}>ಕನ್ನಡ</option><option value="ml" {% if language=='ml' %}selected{% endif %}>മലയാളം</option><option value="or" {% if language=='or' %}selected{% endif %}>ଓଡ଼ିଆ</option><option value="pa" {% if language=='pa' %}selected{% endif %}>ਪੰਜਾਬੀ</option>
</select></div>
</div></div>
<script>function showRole(r){document.getElementById('farmerPanel').classList.toggle('active',r==='farmer');document.getElementById('adminPanel').classList.toggle('active',r==='admin');document.getElementById('farmerTab').classList.toggle('active',r==='farmer');document.getElementById('adminTab').classList.toggle('active',r==='admin');}</script></body></html>
"""
...
def login_required(view):
    ...
    def wrapped(*args, **kwargs):
        if not session.get("role"):
            # API callers must receive JSON, not the HTML login page.
            # Otherwise fetch(...).json() fails with "Unexpected token <".
            if request.path.startswith("/api/"):
                return jsonify({
...
.farmer-side-stack{display:grid;gap:16px;align-content:start}
.portal-side-card{padding:20px}
.portal-side-card h3{margin:0 0 8px;color:#14532d;font-size:20px}
.portal-side-card .side-muted{color:#6b7280;font-size:14px;line-height:1.5}
.centre-info{display:grid;gap:8px;margin:14px 0}
.centre-info-row{display:flex;justify-content:space-between;gap:12px;align-items:center;font-size:14px}
.centre-info-row strong{color:#166534}
.side-action{margin-top:10px;width:100%}
.procurement-rate{font-size:24px;font-weight:800;color:#166534;margin:8px 0 14px}
.payment-list{display:grid;gap:8px;margin-top:8px;font-size:14px}
.ai-quick-grid{display:grid;grid-template-columns:1fr 1fr;gap:9px;margin-top:13px}
.ai-quick-btn{background:#f0fdf4;color:#166534;border:1px solid #bbf7d0;padding:10px;border-radius:10px;font-size:13px;text-align:left}
.ai-quick-btn:hover{background:#dcfce7}
@media(max-width:850px){.dashboard{grid-template-columns:1fr}.ai-quick-grid{grid-template-columns:1fr 1fr}}
...
<section id="registration-success" style="margin-top:28px">
<div class="registration-success-card">
  <div class="registration-success-head">
    <div class="registration-success-check">✓</div>
    <div><h2 data-i18n="registration_complete"></h2><p class="registration-success-sub" data-i18n="registration_success_sub"></p></div>
  </div>
  <div class="registration-token-box">
    <div class="registration-token-label" data-i18n="digital_token_label"></div>
    <div class="registration-token-value">{{registration_success.token}}</div>
  </div>
  <div class="registration-success-grid">
    <div><small data-i18n="tracking_id_label"></small><b>{{registration_success.tracking_id}}</b></div>
    <div><small data-i18n="registered_farmer"></small><b>{{registration_success.name}}</b></div>
    <div><small data-i18n="registered_crop"></small><b>{{registration_success.crop}}</b></div>
    <div><small data-i18n="registered_quantity"></small><b>{{registration_success.quantity}} <span data-i18n="quantity_unit"></span></b></div>
  </div>
  <div class="registration-success-grid" style="grid-template-columns:1fr;">
    <div><small data-i18n="booked_slot"></small><b>{{registration_success.slot}}</b></div>
  </div>
  <p class="registration-success-note" data-i18n="token_note"></p>
  <div class="registration-success-actions">
    <a class="btn" href="#status" data-i18n="view_dashboard"></a>
    <a class="btn" href="#tracking" onclick="setTimeout(()=>loadTracking('{{registration_success.token}}'),100)" data-i18n="track_shipment"></a>
  </div>
</div>
</section>
{% endif %}
...
<label data-i18n="crop"></label><select name="crop" onchange="updatePortalCrop()"><option>Paddy</option><option>Wheat</option><option>Maize</option><option>Other</option></select>
...
<div class="farmer-side-stack">
  <div class="card portal-side-card">
  ...
  <div class="card portal-side-card">
    <h3 data-i18n="centre_card_title"></h3>
    <div class="centre-info">
      <div class="centre-info-row"><span>📍 <span data-i18n="centre_name"></span></span></div>
      <div class="centre-info-row"><span data-i18n="centre_distance"></span></div>
      <div class="centre-info-row"><span data-i18n="centre_open"></span><strong data-i18n="centre_hours"></strong></div>
    </div>
    <button type="button" class="side-action" onclick="viewProcurementCentre()" data-i18n="view_location"></button>
  </div>

  <div class="card portal-side-card">
    <h3 data-i18n="proc_info_title"></h3>
    <div class="side-muted"><span data-i18n="proc_crop"></span>: <strong id="portalCropName">Paddy</strong></div>
    <div class="procurement-rate">₹ — <span style="font-size:15px;font-weight:600" data-i18n="per_quintal"></span></div>
    <div class="side-muted" data-i18n="proc_rate"></div>
    <div class="payment-list">
      <strong data-i18n="proc_payment"></strong>
      <span data-i18n="bank_transfer"></span>
      <span data-i18n="digital_status"></span>
      <span data-i18n="track_payment"></span>
    </div>
    <p class="side-muted" style="margin-top:10px" data-i18n="indicative_note"></p>
  </div>

  <div class="card portal-side-card">
    <h3 data-i18n="ai_quick_title"></h3>
    <p class="side-muted" data-i18n="ai_quick_sub"></p>
    <div class="ai-quick-grid">
      <button type="button" class="ai-quick-btn" onclick="askAIQuick('q1')" data-i18n="ai_q1"></button>
      <button type="button" class="ai-quick-btn" onclick="askAIQuick('q2')" data-i18n="ai_q2"></button>
      <button type="button" class="ai-quick-btn" onclick="askAIQuick('q3')" data-i18n="ai_q3"></button>
      <button type="button" class="ai-quick-btn" onclick="askAIQuick('q4')" data-i18n="ai_q4"></button>
    </div>
  </div>
</div>
</div>
...
async function loadTracking(tokenOverride=null){
  ...
  try{
    ...
    const d=await readJsonResponse(response);
...
async function simulateTrackingStage(){
  if(!trackingToken){ alert((translations[currentLanguage] || translations.en).load_token_first); return; }
  try{
    const currentResponse=await fetch(`/api/tracking/${trackingToken}`);
    const currentData=await readJsonResponse(currentResponse);
    const current=currentData.stage;
...
async function loadSmartFeatures(tokenOverride=null){
  ...
  try{
    ...
    const effort=await readJsonResponse(effortRes); const trace=await readJsonResponse(traceRes); const rej=await readJsonResponse(rejectionRes);
...
async function loadFarmerTraceAndRejections(token){
  try{
    ...
    const trace=await readJsonResponse(tr); const rej=await readJsonResponse(rr);
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const isAdminPortal = !!document.getElementById("adminConsole");
  if(savedToken && document.getElementById("trackingToken")){ loadTracking(savedToken); }
  // Farmer sessions can auto-load their own token. Admin smart features must
  // use the token explicitly selected in the admin panel, avoiding stale
  // browser localStorage after a server restart or another farmer login.
  if(savedToken && document.getElementById("featureToken") && !isAdminPortal){
    document.getElementById("featureToken").value=savedToken;
    loadSmartFeatures(savedToken);
  }
  loadWeather();
  refreshQueueDisplay();
  if(document.getElementById("adminConsole")) loadAdminSummary();
...
function viewProcurementCentre(){
  const destination = encodeURIComponent("Kisan Procurement Centre");
  if(navigator.geolocation){
    navigator.geolocation.getCurrentPosition(pos=>{
      const origin = `${pos.coords.latitude},${pos.coords.longitude}`;
      window.open(`https://www.google.com/maps/dir/?api=1&origin=${encodeURIComponent(origin)}&destination=${destination}&travelmode=driving`,"_blank");
    },()=>{
...
function updatePortalCrop(){
  const cropSelect=document.querySelector('select[name="crop"]');
  const cropName=document.getElementById("portalCropName");
  if(cropSelect && cropName) cropName.textContent=cropSelect.options[cropSelect.selectedIndex].text;
}
function askAIQuick(key){
  const t=translations[currentLanguage] || translations.en;
  const questions={q1:t.ai_q1,q2:t.ai_q2,q3:t.ai_q3,q4:t.ai_q4};
  toggleAI();
  const input=document.getElementById("aiInput");
  if(input){ input.value=questions[key] || ""; sendAI(); }
}
function toggleAI(){
...
VALID_QUANTITY_MESSAGES = {
    "en": "Please enter a valid positive quantity.",
    "hi": "कृपया मान्य और शून्य से अधिक मात्रा दर्ज करें।",
    "bn": "অনুগ্রহ করে একটি বৈধ এবং শূন্যের বেশি পরিমাণ দিন।",
    "ta": "சரியான மற்றும் பூஜ்ஜியத்தை விட அதிகமான அளவை உள்ளிடவும்.",
    "as": "অনুগ্ৰহ কৰি শূন্যতকৈ অধিক বৈধ পৰিমাণ লিখক।",
    "te": "దయచేసి చెల్లుబాటు అయ్యే సానుకూల పరిమాణాన్ని నమోదు చేయండి.",
    "mr": "कृपया वैध आणि शून्यापेक्षा जास्त प्रमाण प्रविष्ट करा.",
    "gu": "કૃપા કરીને માન્ય અને શૂન્ય કરતાં વધુ જથ્થો દાખલ કરો.",
    "kn": "ದಯವಿಟ್ಟು ಮಾನ್ಯವಾದ ಧನಾತ್ಮಕ ಪ್ರಮಾಣವನ್ನು ನಮೂದಿಸಿ.",
    "ml": "ദയവായി സാധുവായ പോസിറ്റീവ് അളവ് നൽകുക.",
    "or": "ଦୟାକରି ଏକ ବୈଧ ଏବଂ ଶୂନ୍ୟଠାରୁ ଅଧିକ ପରିମାଣ ଦିଅନ୍ତୁ।",
    "pa": "ਕਿਰਪਾ ਕਰਕੇ ਵੈਧ ਅਤੇ ਸਿਫ਼ਰ ਤੋਂ ਵੱਧ ਮਾਤਰਾ ਦਰਜ ਕਰੋ।",
}

# Queue state is stored in Supabase PostgreSQL via app_state.
# This avoids the per-instance reset caused by in-memory globals on Vercel.
...
def ai_assistant():
    ...
    Token/registration information comes directly from Supabase PostgreSQL.
    ...
    current_num = get_current_queue_token(conn)
...
def _render_portal(role):
    ...
    registration_success = session.pop("registration_success", None) if role == "farmer" else None
...
def home():
    ...
    if language not in TRANSLATIONS: language = "en"
    session["language"] = language
    return render_template_string(LOGIN_HTML, language=language, login_t=LOGIN_TRANSLATIONS[language])
...
def login():
    ...
    if role == "admin":
        ...
        flash(LOGIN_TRANSLATIONS[language]["admin_err"])
    ...
    if not row:
        flash(LOGIN_TRANSLATIONS[language]["farmer_err"])
        return redirect(url_for("home", lang=language))
...
def register():
    conn = db()
    next_number = allocate_token_number(conn)
    token = f"P{next_number:03d}"
    ...
    try:
        ...
        flash(VALID_QUANTITY_MESSAGES.get(language, VALID_QUANTITY_MESSAGES["en"]))
        conn.close()
    ...
    conn.execute("""INSERT INTO farmers
        ...
        VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)""",
        (token, name, mobile, farmer_id, crop, quantity_value, slot,
    ...
    return redirect(url_for("farmer_page", lang=language) + "#registration-success")
...
def tracking_status(token):
    ...
    try:
        ...
        # Main tracking record. Keep this query independent from history so
        # an older/malformed history table cannot break the live tracking card.
        row = conn.execute("""
            SELECT f.token,f.name,f.crop,f.quantity,f.status,f.tracking_id,
                   t.stage,t.location_name,t.latitude,t.longitude,t.accuracy,
                   t.last_updated,t.gps_active
            FROM farmers f
            JOIN shipment_tracking t ON f.token=t.token
            WHERE f.token=?
        """, (token,)).fetchone()
        ...
        try:
            history_rows = conn.execute("""
                SELECT stage,location_name,latitude,longitude,updated_at
            ...
            # Live tracking should still work even if legacy history data
            # needs migration.
            app.logger.exception("Could not load tracking history for %s", token)
            history = []
        ...
        return jsonify({
            ...
            "accuracy": row[10],
            "last_updated": row[11],
            "gps_active": bool(row[12]),
            "history": history
        })

    except Exception as exc:
        app.logger.exception("Tracking API failed for token %s", token)
        return jsonify({
...
def tracking_location(token):
    ...
    conn.execute("""UPDATE shipment_tracking
                   SET stage='In Transit', location_name='Live GPS Location',
                       latitude=?, longitude=?, accuracy=?, last_updated=?, gps_active=TRUE
...
def tracking_stop(token):
    token = token.strip().upper()
    conn = db()
    cur = conn.execute("UPDATE shipment_tracking SET gps_active=FALSE WHERE token=?", (token,))
    conn.commit(); conn.close()
    if cur.rowcount == 0:
        return jsonify({"error":"Tracking token not found."}), 404
...
def tracking_stage(token):
    ...
    conn.execute("""UPDATE shipment_tracking SET stage=?,location_name=?,last_updated=?,gps_active=FALSE WHERE token=?""",
...
def health():
    """Deployment health check for Flask + Supabase PostgreSQL."""
    conn = None
    try:
        conn = db()
        row = conn.execute("SELECT current_database(), current_timestamp").fetchone()
        return jsonify({
            "ok": True,
            "application": "KisanGati",
            "database": "ok",
            "database_name": row[0] if row else None,
            "storage": "Supabase PostgreSQL",
        })
    except Exception:
        app.logger.exception("KisanGati database health check failed")
        return jsonify({
            "ok": False,
            "application": "KisanGati",
            "database": "error",
            "storage": "Supabase PostgreSQL",
            "error": "Database connection failed. Check DATABASE_URL and Supabase availability."
        }), 503
    finally:
        if conn is not None:
            conn.close()
...
def admin_summary():
    ...
    current_token = get_current_queue_token(conn)
    conn.close()
    return jsonify({"farmers":farmers,"tracked_lots":tracked,"rejections":rejections,"current_token":f"P{current_token:03d}"})

@app.route("/api/queue")
def queue():
    conn = db()
    current = get_current_queue_token(conn)
    conn.close()
...
def queue_next():
    conn = db()
    try:
        current = advance_queue_token(conn)
        conn.commit()
    except Exception:
        conn.rollback()
        conn.close()
        raise
    conn.close()
    return jsonify(current=f"P{current:03d}")
